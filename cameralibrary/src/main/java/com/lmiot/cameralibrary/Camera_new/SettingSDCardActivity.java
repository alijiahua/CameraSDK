...
import com.lmiot.cameralibrary.Camera_new.adapter.MoveVideoTimingAdapter;
import com.lmiot.cameralibrary.Camera_new.adapter.VideoTimingAdapter;
import com.lmiot.cameralibrary.Camera_new.bean.AlermBean;
import com.lmiot.cameralibrary.Camera_new.bean.SdcardBean;
...
public class SettingSDCardActivity extends BaseActivity implements View.OnClickListener,BridgeService.SDCardInterface, BridgeService.VideoTimingInterface, BridgeService.TimingInterface, BridgeService.CallBack_AlarmParamsInterface {

    private final int TIMEOUT = 3000;
    private static String strDID = "";// camera id
    private static String strPWD = "";// camera pwd
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case PARAMS:
                    ...
                    mTvSdTotal.setText(sdcardBean.getSdtotal() + "MB");
                    mTvSdRemain.setText(sdcardBean.getSdfree() + "MB");
                    ...
                    if (sdcardBean.getRecord_sd_status() == 1) {
                        ...
                        mTvState.setText(getString(R.string.sdcard_video));
                    } else if (sdcardBean.getRecord_sd_status() == 3) {
                        mTvState.setText(getString(R.string.sdcard_file_error));
                    } else if (sdcardBean.getRecord_sd_status() == 4) {
                        mTvState.setText(getString(R.string.sdcard_isformatting));
                    } else {
                        mTvState.setText(SettingSDCardActivity.this
                                .getResources().getString(
                                        R.string.sdcard_status_info));
                    }
                    mCbxCoverage.setChecked(true);
                    if (sdcardBean.getRecord_time_enable() == 1) {
                        mCbxRecordTime.setChecked(true);
                    } else {
                        mCbxRecordTime.setChecked(false);
                    }
                    // mEditRecordLength.setText(sdcardBean.getRecord_timer() + "");
                    mEditRecordLength.setText(15 + "");
                    break;
                default:
                    break;
            }
    ...
    private CheckBox mCbxCoverage;
    private EditText mEditRecordLength;
    private CheckBox mCbxRecordTime;
    private ImageView mRlAddPlan;
    private LinearLayout mTvVideoPlan;
    private MyListView mLvVideoPlan;
    private RelativeLayout mRlVideoPlan;
    private ImageView mRlAddMovePlan;
    private LinearLayout mTvMovePlan;
    private MyListView mLvMovePlan;
    ...
    private void initView() {
        ...
        mBtnFormat = findViewById(R.id.btn_format);
        mTvState = findViewById(R.id.tv_state);
        mCbxCoverage = findViewById(R.id.cbx_coverage);
        mEditRecordLength = findViewById(R.id.edit_record_length);
        mCbxRecordTime = findViewById(R.id.cbx_record_time);
        mRlAddPlan = findViewById(R.id.rl_add_plan);
        mTvVideoPlan = findViewById(R.id.tv_video_plan);
        mLvVideoPlan = findViewById(R.id.lv_video_plan);
        mRlVideoPlan = findViewById(R.id.rl_video_plan);
        mRlAddMovePlan = findViewById(R.id.rl_add_move_plan);
        mTvMovePlan = findViewById(R.id.tv_move_plan);
        mLvMovePlan = findViewById(R.id.lv_move_plan);
        mRlMovePlan = findViewById(R.id.rl_move_plan);
        mRlPlanAll = findViewById(R.id.rl_plan_all);
        ...
        mLvVideoPlan.setAdapter(adapter);
        planmap = new HashMap<Integer, Integer>();
        mLvVideoPlan.setOnItemClickListener(new OnItemClickListener() {
        ...
        mLvMovePlan.setAdapter(moveAdapter);
        moveplanmap = new HashMap<Integer, Integer>(); //移动侦测录像
        mLvMovePlan.setOnItemClickListener(new OnItemClickListener() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 1:// 设置成功
                    ...
                    break;
                case 2:// 回调成功
                    Log.e("2222alermBean)", "************" + alermBean.getMotion_armed());
    ...
    public void onClick(View view) {
        ...
        } else if (i == R.id.cbx_record_time) {
            if (mCbxRecordTime.isChecked()) {
