...
import com.lmiot.cameralibrary.Camera_new.BridgeService.DateTimeInterface;
import com.lmiot.cameralibrary.Camera_new.BridgeService.PlayBackInterface;
...
public class PlayBackActivity extends BaseActivity implements PlayBackInterface, DateTimeInterface
{
	...
	@Override
		public void callBackDatetimeParams(String did, int now, int tz, int ntp_enable, String ntp_svr) {
