package com.lmiot.cameralibrary.Camera_new.utils;

import android.os.Environment;
import android.util.Log;

import com.lmiot.cameralibrary.Camera_new.PlayActivity;
import com.lmiot.cameralibrary.Camera_new.PlayActivity.VideoRecorder;
import com.lmiot.cameralibrary.Camera_new.bean.VideoRecordBean;
	...
	private class myRunnable implements Runnable {
		...
		public void run() {
			...
			try {
				...
				i++;
				String strDate = date;
				String p = strDate + "_" + strDID+"_"+i+ ".mp4";
